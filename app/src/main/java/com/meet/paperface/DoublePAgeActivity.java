...
public class DoublePAgeActivity extends AppCompatActivity {
    private Button ok;
    private Button done;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_double_page);
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (pages2.isEmpty() || pages2.equals("0") || pages2.equals("00") || pages2.equals("000") || pages2.equals("0000")) {
                    Toast.makeText(DoublePAgeActivity.this, "Please enter Bunch of pages", Toast.LENGTH_SHORT).show();
                ...
                dr1.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        if (pages1.isEmpty()) {
                            ...
                            Toast.makeText(DoublePAgeActivity.this, "Please Touch on ok", Toast.LENGTH_SHORT).show();
                            ...
                            hashMap.put("type","Double Side");

                            dr.child(myuid).push().setValue(hashMap).addOnCompleteListener(DoublePAgeActivity.this, new OnCompleteListener<Void>() {
                                @Override
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {

                                        Intent intent = new Intent(DoublePAgeActivity.this, MainLayout.class);
                                        startActivity(intent);
                                        finish();

                                        Toast.makeText(DoublePAgeActivity.this, "Your Order is successfully Placed", Toast.LENGTH_SHORT).show();

                                    } else {
                                        Toast.makeText(DoublePAgeActivity.this, "Something Error", Toast.LENGTH_SHORT).show();
