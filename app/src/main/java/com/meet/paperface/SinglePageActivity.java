        ...
        ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (pages2.isEmpty() || pages2.equals("0") || pages2.equals("00") || pages2.equals("000") || pages2.equals("0000")) {
                    Toast.makeText(SinglePageActivity.this, "Please enter Bunch of pages", Toast.LENGTH_SHORT).show();
                ...
                dr1.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        if (pages1.isEmpty()) {
                            ...
                            Toast.makeText(SinglePageActivity.this, "Please Touch on ok", Toast.LENGTH_SHORT).show();
                            ...
                            hashMap.put("type", "Single Side");

                            dr.child(myuid).push().setValue(hashMap).addOnCompleteListener(SinglePageActivity.this, new OnCompleteListener<Void>() {
                                @Override
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {

                                        Intent intent = new Intent(SinglePageActivity.this, MainLayout.class);
                                        startActivity(intent);
                                        finish();
                                        Toast.makeText(SinglePageActivity.this, "Your Order is successfully Placed", Toast.LENGTH_SHORT).show();

                                    } else {
                                        Toast.makeText(SinglePageActivity.this, "Something Error", Toast.LENGTH_SHORT).show();
